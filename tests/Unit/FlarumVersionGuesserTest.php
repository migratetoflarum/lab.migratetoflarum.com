...
class FlarumVersionGuesserTest extends TestCase
{
    ...
    function testV110Typical()
    {
        $html = file_get_contents(__DIR__ . '/version-guesser/1.1.0-typical.html');
    ...
    function testV140Typical()
    {
        $html = file_get_contents(__DIR__ . '/version-guesser/1.4.0-typical.html');
    ...
    function testV171Typical()
    {
        $html = file_get_contents(__DIR__ . '/version-guesser/1.7.1-typical.html');
    ...
    function testV180Typical()
    {
        $html = file_get_contents(__DIR__ . '/version-guesser/1.8.0-typical.html');
